...
LEFT JOIN tb_list_order ON tb_daftar_menu.id = tb_list_order.menu GROUP BY tb_daftar_menu.id
ORDER BY tb_daftar_menu.id ASC");

$result_chart = array();
while ($row_chart = mysqli_fetch_array($query_chart)) {
    $result_chart[] = $row_chart;
}
...
<div class="col-lg-9 mt-2 rounded">
            ...
            foreach ($result as $data) {
                ...
                <div class="carousel-item <?php echo $aktif ?>">
                    <img src="assets/img/<?php echo $data['foto'] ?>" class="img-fluid"
                        style="height: 270px; width: 1000px; object-fit: cover;" alt="...">
    ...
    <div class="card mt-4 border-0 bg-light">
        <div class="card-body text-center">
            <h5 class="card-title">RECAFE - Aplikasi Pemesanan Makanan dan Minuman Cafe</h5>
            <p class="card-text">Aplikasi pemesanan makanan dan minuman yang mudah dan praktis. Nikmati beragam makanan
                dan minuman favorit Anda dengan beberapa klik. Pesan, bayar dan lacak pesanan Anda kapan saja dengan
                mudah melalui Aplikasi ini.</p>
            <a href="orders" class="btn btn-primary">Buat Order</a>
        </div>
    </div>
    <!-- akhir judul -->
    <!-- chard -->

...
$query = mysqli_query(
  $conn,
  "SELECT tb_order.*,tb_bayar.*, nama, SUM(harga*jumlah) as total_harga FROM tb_order
...
<div class="col-lg-9 mt-2 rounded">
  <div class="card">
    ...
    <div class="card-body">
                ...
                <div class="row">
                  <div class="col-lg-3">
                    <div class="form-floating mb-3">
                      <input type="text" class="form-control" id="order" name="kode_order"
                        value="<?php echo rand(100, 999) . date('-Y-m-d,H:i:s'); ?>" readonly>
      ...
      <?php
      if (empty($result)) {
        echo "<div class='alert alert-danger'>Data order Tidak Ada</div>";
      } else {
        ?>
                  ...
                  <td>
                    <div class="d-flex">
                      ...
                      <button
                        ...
                        data-bs-target="#ModalEdit<?php echo $row['id_order']; ?>" data-bs-toggle="modal"><i
                          class="bi bi-pencil-square"></i></button>
                      <button
                        class="<?php echo (!empty($row['id_bayar'])) ? "btn btn-secondary disabled" : "btn btn-danger"; ?>"
                        data-bs-target="#ModalDelete<?php echo $row['id_order']; ?>" data-bs-toggle="modal"><i
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form class="needs-validation" novalidate action="proses/proses_edit_order.php" method="POST">
                  ...
                  <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    <button type="submit" class="btn btn-primary" name="edit_order_validate" value="12345">Edit
                      Order</button>
                  </div>
                </form>
              </div>

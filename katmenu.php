...
<div class="col-lg-9 mt-2 rounded">
  <div class="card">
    ...
    <div class="card-body">
      <div class="row">
        <div class="col d-flex justify-content-end">
          <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#ModalTambahKatMenu">Tambah Kategori
            Menu</button>
        </div>
      </div>
      <!-- Modal tambah kategori menu -->
      <div class="modal fade" id="ModalTambahKatMenu" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
                  ...
                  <div class="col-lg-6">
                    <div class="form-floating mb-3">
                      <select class="form-select" aria-label="Default select example" name="jenismenu" id="" required>
                        <option selected hidden>Pilih jenis menu</option>
    ...
    <?php
    if (empty($result)) {
      echo "<div class='alert alert-danger'>Data kategori menu Tidak Ada</div>";
    } else {
      ?>
      <!-- Modal tabel kategori menu  -->
          ...
          <tbody>
            ...
            foreach ($result as $row) {
              ...
              <tr>
                ...
                <td class="d-flex">
                  <button class="btn btn-warning btn-sm me-1" data-bs-target="#ModalEdit<?php echo $row['id_kat_menu']; ?>"
                    data-bs-toggle="modal"><i class="bi bi-pencil-square"></i></button>
                  <button class="btn btn-danger btn-sm me-1" data-bs-target="#ModalDelete<?php echo $row['id_kat_menu']; ?>"
      ...
      <!-- akhir Modal tabel kategori menu  -->
      <?php
    }
    ?> <?php
     foreach ($result as $row) {
      ...
      <div class="modal fade" id="ModalEdit<?php echo $row['id_kat_menu']; ?>" tabindex="-1"
        ...
        <div class="modal-dialog modal-xl modal-fullscreen-md-down">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
              <button type="submit" class="btn btn-primary" name="edit_katmenu_validate" value="12345">Save
                changes</button>
            </div>
            </form>
          </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="needs-validation" novalidate action="proses/proses_delete_katmenu.php" method="POST">
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <h5>Apakah anda yakin ingin menghapus kategori menu <b>
                        <?php echo $row['kategori_menu']; ?>
                      </b>?</h5>
                  </div>
                </div>

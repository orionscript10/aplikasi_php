                                    ...
                                    <div class="col-lg-6">
                                        <div class="input-group mb-3">
                                            <input type="file" class="form-control py-3" id="uploadFoto" name="foto"
                                                placeholder="Upload Foto Menu" aria-label="Upload Foto Menu" required>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <button class="btn btn-info btn-sm me-1"
                                                data-bs-target="#ModalView<?php echo $row['id']; ?>" data-bs-toggle="modal"><i
                                                    class="bi bi-eye"></i></button>
                                            <button class="btn btn-warning btn-sm me-1"
                                                data-bs-target="#ModalEdit<?php echo $row['id']; ?>" data-bs-toggle="modal"><i
                                                    class="bi bi-pencil-square"></i></button>
                                            <button class="btn btn-danger btn-sm me-1"
                                                data-bs-target="#ModalDelete<?php echo $row['id']; ?>" data-bs-toggle="modal"><i
                                ...
                                <form class="needs-validation" novalidate action="proses/proses_input_menu.php"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control" id="floatingInput"
                                                    placeholder="Nama Menu" value="<?php echo $row['nama_menu']; ?>"
                                                    readonly>
                                                <label for="floatingInput">Nama Menu</label>
                                                <div class="invalid-feedback">
                                                    Masukkan Nama Menu.
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-floating mb-3">
                                                <input type="number" class="form-control" id="floatingInput"
                                                    placeholder="Stok" name="stok" value="<?php echo $row['stok']; ?>"
                                                    readonly>
                                                <label for="floatingInput">Stok</label>
                                                <div class="invalid-feedback">
                                                    Masukkan stok.

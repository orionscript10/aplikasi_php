...
<div class="col-lg-9 mt-2 rounded">
  <div class="card">
    ...
    <?php
    if (empty($result)) {
      echo "<div class='alert alert-danger'>Data user Tidak Ada</div>";
    } else {
      ?>
          ...
          <tbody>
            ...
            foreach ($result as $row) {
              ...
              <tr>
                ...
                <td class="d-flex">
                  <button class="btn btn-info btn-sm me-1" data-bs-target="#ModalView<?php echo $row['id']; ?>"
                    data-bs-toggle="modal"><i class="bi bi-eye"></i></button>
                  <button class="btn btn-warning btn-sm me-1" data-bs-target="#ModalEdit<?php echo $row['id']; ?>"
                    data-bs-toggle="modal"><i class="bi bi-pencil-square"></i></button>
                  <button class="btn btn-danger btn-sm me-1" data-bs-target="#ModalDelete<?php echo $row['id']; ?>"
                    data-bs-toggle="modal"><i class="bi bi-trash"></i></button>
                  <button class="btn btn-secondary btn-sm" data-bs-target="#ModalResetPassword<?php echo $row['id']; ?>"
                    data-bs-toggle="modal"><i class="bi bi-key"></i></button>
                </td>
              </tr>
              <?php
            } ?>
            ...
            <div class="modal-body">
              <form class="needs-validation" novalidate action="proses/proses_input_user.php" method="POST">
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    <div class="form-floating mb-3">
                      <input disabled type="email" class="form-control" id="floatingInput" placeholder="name@gmail.com"
                ...
                <div class="row">
                  <div class="col-lg-4">
                    <div class="form-floating mb-3">
                      <select disabled class="form-select" aria-label="Default selest example" name="level" id=""
                        required>
                  ...
                  <div class="col-lg-8">
                    <div class="form-floating mb-3">
                      <input disabled type="number" class="form-control" id="floatingInput" placeholder="08**********"
            ...
            <div class="modal-body">
              <form class="needs-validation" novalidate action="proses/proses_edit_user.php" method="POST">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    <div class="form-floating mb-3">
                      <input <?php echo ($row['username'] == $_SESSION['username_recafe']) ? 'disabled' : ''; ?>
                        type="email" class="form-control" id="floatingInput" placeholder="name@gmail.com" name="username"
                ...
                <div class="row">
                  <div class="col-lg-4">
                    <div class="form-floating mb-3">
                      <select class="form-select" aria-label="Default select example" name="level" id="" required>
                        ...
                        foreach ($data as $key => $value) {
                          $levelValue = $key + 1;
                          if ($row['level'] == $levelValue) {
                            echo "<option selected value='$levelValue'>$value</option>";
                          } else {
                            echo "<option value='$levelValue'>$value</option>";
                          }
                        }
                        ?>
                      </select>
                  ...
                  <div class="col-lg-8">
                    <div class="form-floating mb-3">
                      <input type="number" class="form-control" id="floatingInput" placeholder="08**********" name="nohp"
      ...
      <div class="modal fade" id="ModalDelete<?php echo $row['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-md modal-fullscreen-md-down">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="needs-validation" novalidate action="proses/proses_delete_user.php" method="POST">
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <?php
                    if ($row['username'] == $_SESSION['username_recafe']) {
                      echo "<div class='alert alert-danger' role='alert'>Tidak dapat menghapus user yang sedang login!</div>";
                    } else {
                      echo "<div class='alert alert-warning' role='alert'>Data yang dihapus tidak dapat dikembalikan! <b>$row[username]</b></div>";
                    }
                    ?>
                  </div>
                </div>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
              <button type="submit" class="btn btn-danger" name="input_user_validate" value="12345" <?php echo ($row['username'] == $_SESSION['username_recafe']) ? 'disabled' : ''; ?>>Hapus</button>
            </div>
            </form>
          </div>
        </div>
      ...
      <div class="modal fade" id="ModalResetPassword<?php echo $row['id']; ?>" tabindex="-1"
        ...
        <div class="modal-dialog modal-md modal-fullscreen-md-down">
          <div class="modal-content">
              ...
              <form class="needs-validation" novalidate action="proses/proses_reset_password.php" method="POST">
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <?php
                    if ($row['username'] == $_SESSION['username_recafe']) {
                      echo "<div class='alert alert-danger' role='alert'>Tidak dapat mereset password user yang sedang login!</div>";
                    } else {
                      echo "<div class='alert alert-warning' role='alert'>Password akan direset ke default! <b>$row[username]</b></div>";
                    }
                    ?>
                  </div>
                </div>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
              <button type="submit" class="btn btn-success" name="input_user_validate" value="12345" <?php echo ($row['username'] == $_SESSION['username_recafe']) ? 'disabled' : ''; ?>>Reset Password</button>
            </div>
            </form>
          </div>
        </div>
